...
var codexRootTypedDefinitions = []CodexFeatureDefinition{
	...
	{Section: "root", Key: "approvals_reviewer", Stage: "advanced", ValueType: "enum", Options: []string{"auto_review", "human"}},
	...
	{Section: "root", Key: "cli_auth_credentials_store", Stage: "advanced", ValueType: "enum", Options: []string{"file", "keyring", "auto"}},
	...
	{Section: "root", Key: "experimental_thread_store", Stage: "advanced", ValueType: "enum", Options: []string{"file", "sqlite"}},
	...
	{Section: "root", Key: "mcp_oauth_credentials_store", Stage: "advanced", ValueType: "enum", Options: []string{"file", "keyring", "auto"}},
	...
	{Section: "root", Key: "model_auto_compact_token_limit_scope", Stage: "advanced", ValueType: "enum", Options: []string{"full_context", "after_carried_prefix"}},
	...
	{Section: "root", Key: "personality", Stage: "advanced", ValueType: "enum", Options: []string{"default", "concise", "friendly"}},
...
var codexModelProviderEditableDefinitions = []CodexFeatureDefinition{
	...
	{Section: "model_providers", Key: "wire_api", Stage: "stable", ValueType: "enum", Options: []string{"responses", "chat", "chat_completions"}},
