...
const openAICompatibleComposeLabelClass = 'text-[length:var(--font-size-ui-xs)] font-medium text-[var(--gt-ink-muted)]';
const openAICompatibleComposeTitleClass = 'mt-1 text-sm font-semibold text-[var(--gt-ink-primary)]';
const openAICompatibleComposeHintClass = 'text-[length:var(--font-size-ui-2xs)] font-medium text-[var(--gt-ink-muted)]';
