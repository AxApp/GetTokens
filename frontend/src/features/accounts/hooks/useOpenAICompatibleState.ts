        ...
        () =>
          UpdateOpenAICompatibleProvider(
            main.UpdateOpenAICompatibleProviderInput.createFrom({
              ...
              quotaCurl: detailDraft.quotaCurl || "",
              quotaEnabled: Boolean(detailDraft.quotaEnabled && detailDraft.quotaCurl),
              billingCurl: detailDraft.billingCurl || "",
              billingEnabled: Boolean(detailDraft.billingEnabled && detailDraft.billingCurl),
              platformCookie: detailDraft.platformCookie || "",
              curlVariables: detailDraft.curlVariables || {},
