            ...
            content={
              <div data-accounts-toolbar-filter-menu="quiet" className="flex flex-col gap-3.5">
                <div className="grid gap-2">
                  <p className="text-[length:var(--gt-font-size-xs)] font-semibold text-[var(--gt-ink-muted)]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid gap-2">
                    <div className="grid grid-cols-3 gap-1">
                      <p className="col-span-3 text-[length:var(--gt-font-size-xs)] font-semibold text-[var(--gt-ink-muted)]">
                    ...
                    {planOptions.length > 0 || !planAvailabilityResolved ? (
                      <div className="grid grid-cols-2 gap-1">
                        <p className="col-span-2 text-[length:var(--gt-font-size-xs)] font-semibold text-[var(--gt-ink-muted)]">
...
function FilterTernaryOptionRow({
  ...
  return (
    <div className="grid gap-1">
      <p className="px-2.5 text-[length:var(--gt-font-size-xs)] font-semibold text-[var(--gt-ink-muted)]">
        {title}
      </p>
      <div className="grid grid-cols-3 gap-1">
