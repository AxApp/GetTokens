...
const rateLimitRulesInputClass = 'h-9 w-full rounded-md border border-[var(--gt-border-default)] bg-[var(--gt-surface-canvas)] px-2 py-1 text-sm text-[var(--gt-ink-primary)] outline-none transition-colors focus:border-[var(--gt-focus-ring)] disabled:cursor-not-allowed disabled:opacity-60';
