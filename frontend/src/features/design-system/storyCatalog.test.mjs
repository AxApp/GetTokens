...
test('account detail modules expose design-system anatomy and runtime states', async () => {
  ...
  assert.match(modalStorySource, /AccountRuntimeEvidenceSection/);
  ...
  assert.match(unifiedDetailSource, /AccountRuntimeEvidenceSection/);
  assert.doesNotMatch(unifiedDetailSource, /AccountDetailOverviewGrid/);
  assert.match(openAICompatibleDetailSource, /layout="cards"/);
  assert.match(openAICompatibleModalSource, /AccountRuntimeEvidenceSection/);
