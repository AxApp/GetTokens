...
export const designSystemComponentManifest = [
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '账号详情统一设计语言的 section、field grid、pill、notice、empty state 和 evidence grid primitives，已被账号、OpenAI-compatible、Codex/Claude route 详情复用。',
    matchedPatterns: ['AccountDetailModalFrame'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['section', 'field-grid', 'pill-tones', 'notice', 'empty-state', 'evidence'],
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '统一账号详情页的 header、credentials、verify、quota、billing、evidence 和 footer 已拆成无 Wails 的 section 组件，并通过 Account Modals story 收编。',
    matchedPatterns: ['AccountDetailModalFrame', 'Combobox', 'ToggleSwitch'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['ready', 'missing-fields', 'saving-footer', 'live-billing', 'evidence'],
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: 'OpenAI-compatible 完整详情弹窗已通过 RateLimitRulesAPI mock 隔离规则 CRUD，并在 OpenAI Compatible story 收编，包含从卡片迁入的 evidence 诊断区。',
    matchedPatterns: ['Combobox', 'ToggleSwitch'],
    storyPath: openAICompatibleStoryPath,
    storybookTitle: openAICompatibleStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['rate-limit-composed', 'evidence'],
