...
const openAICompatibleComposeLabelClass = 'text-[length:var(--font-size-ui-xs)] font-medium tracking-[0.08em] text-[var(--gt-ink-muted)]';
const openAICompatibleComposeTitleClass = 'mt-1 text-sm font-semibold text-[var(--gt-ink-primary)]';
const openAICompatibleComposeHintClass = 'text-[length:var(--font-size-ui-2xs)] font-medium tracking-[0.08em] text-[var(--gt-ink-muted)]';
const openAICompatibleComposeInputClass = 'h-9 w-full rounded-md border border-[var(--gt-border-subtle)] bg-[var(--gt-surface-canvas)] px-3 py-1.5 text-[length:var(--font-size-ui-sm)] font-medium text-[var(--gt-ink-primary)] outline-none transition placeholder:text-[var(--gt-ink-muted)] focus:border-[var(--gt-ink-muted)]';
const openAICompatibleComposeButtonClass = 'inline-flex h-9 items-center justify-center rounded-md border border-[var(--gt-border-subtle)] bg-[var(--gt-surface-canvas)] px-3 text-[length:var(--font-size-ui-xs)] font-medium text-[var(--gt-ink-primary)] transition hover:border-[var(--gt-ink-muted)] hover:bg-[var(--gt-surface-muted)]';
...
const openAICompatibleComposeErrorClass = 'rounded-md border border-[color-mix(in_srgb,var(--gt-status-danger)_28%,transparent)] bg-[color-mix(in_srgb,var(--gt-status-danger)_8%,var(--gt-surface-canvas))] px-4 py-3 text-[length:var(--font-size-ui-sm)] font-medium text-[var(--gt-status-danger)]';
