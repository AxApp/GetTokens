...
function ToggleSwitchOverview() {
  ...
  return (
    <div className="grid w-full max-w-4xl gap-4 bg-[var(--bg-surface)] p-6">
      <div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <section className="grid min-h-[8rem] content-center gap-3 border-2 border-[var(--border-color)] bg-[var(--bg-main)] p-4">
