...
test('ProxyPoolFeature uses the current workspace table layout', async () => {
  ...
  assert.match(source, /aria-label="更多操作"[\s\S]*className="inline-flex h-10 w-10 items-center justify-center rounded border border-\[var\(--gt-border-subtle\)\] bg-\[var\(--gt-surface-raised\)\] text-\[var\(--gt-ink-primary\)\][\s\S]*<MoreVertical className="h-5 w-5" strokeWidth=\{2\.5\} \/>/);
  assert.match(source, /className="overflow-hidden rounded-md border border-\[var\(--gt-border-subtle\)\] bg-\[var\(--gt-surface-canvas\)\]"/);
  assert.match(source, /className="flex h-8 w-8 items-center justify-center rounded bg-transparent text-\[var\(--gt-ink-primary\)\] transition hover:bg-\[var\(--gt-surface-muted\)\] disabled:cursor-not-allowed disabled:opacity-50"/);
  assert.match(source, /className="flex h-8 w-8 items-center justify-center rounded bg-transparent text-\[var\(--gt-ink-primary\)\] transition hover:bg-\[var\(--gt-surface-muted\)\] active:scale-95"/);
  ...
  assert.match(source, /const proxyPoolPrimaryButtonClass = 'inline-flex h-9 items-center justify-center rounded border border-\[var\(--gt-border-strong\)\] bg-\[var\(--gt-ink-primary\)\]/);
