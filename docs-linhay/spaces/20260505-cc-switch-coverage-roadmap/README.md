...
本 space 保存 2026-05-05 对照 `cc-switch` 后形成的后续路线判断。`cc-switch` 是多 CLI provider / MCP / Prompts / Skills / 代理 / 用量 / 同步的一体化配置管理器；GetTokens 当前主线是账号池、quota、sidecar relay 和 Codex 工作台。
