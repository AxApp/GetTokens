...
export const designSystemComponentManifest = [
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '统一账号详情页的 header、运行快照、额度/余额并排资源区、credentials、verify、quota、billing、evidence、module layout、card mode 和 footer 已拆成无 Wails 的 section 组件；Quota/Billing 编辑模块在 card mode 中并排展示，并通过 Account Modals story 收编。',
    matchedPatterns: ['AccountDetailModalFrame', 'Combobox', 'ToggleSwitch'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['ready', 'runtime-snapshot', 'runtime-evidence-overview', 'quota-balance-grid', 'quota-billing-side-by-side', 'standard-module-header', 'module-layout', 'card-mode', 'missing-fields', 'saving-footer', 'live-billing', 'evidence'],
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: 'OpenAI-compatible 完整详情弹窗已通过 RateLimitRulesAPI mock 隔离规则 CRUD，并在 OpenAI Compatible story 收编，接入账号详情统一运行快照、evidence 诊断区和页脚保存。',
    matchedPatterns: ['Combobox', 'ToggleSwitch'],
    storyPath: openAICompatibleStoryPath,
    storybookTitle: openAICompatibleStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['rate-limit-composed', 'runtime-snapshot', 'evidence', 'footer-save'],
  ...
  },
  {
    ...
    storybookTitle: openAICompatibleStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['ready-remote-models', 'runtime-snapshot', 'card-mode', 'validation-error', 'fetching-models', 'footer-save'],
