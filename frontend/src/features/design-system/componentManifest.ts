...
export const designSystemComponentManifest = [
  {
    ...
    decisionReason: '完整账号卡已通过 Account Cards story 收编，覆盖常规、带额度条、选择、待删除、列表阻断态和已验证模板应用菜单，auth file 下载依赖已由 runtime wrapper 通过 downloadAuthFile prop 注入。',
    ...
    requiredStates: ['ready', 'quota', 'selection-selected', 'pending-delete', 'list-blocked', 'template-apply-menu'],
  ...
  {
    id: 'accounts-account-detail-auth-file-section',
    componentName: 'AccountDetailAuthFileSection',
    sourcePath: 'frontend/src/features/accounts/components/AccountDetailAuthFileSection.tsx',
    ownerFeature: 'accounts',
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '账号详情 auth-file 配置管理 section 已从统一详情 modal 中拆出，浏览器预览使用本地 mock auth-file content，运行态通过 Wails wrapper 注入。',
    matchedPatterns: ['AccountDetailPrimitives'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['preview-on-demand', 'loading', 'apply-boundary'],
    mockDataSources: ['storybook auth-file account mock', 'previewData auth-file content mock'],
  },
  {
    id: 'accounts-account-detail-layout',
    componentName: 'AccountDetailLayout',
    sourcePath: 'frontend/src/features/accounts/components/AccountDetailLayout.tsx',
    ownerFeature: 'accounts',
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '账号详情 section-nav 布局从统一详情 modal 中拆出，负责左侧导航、scroll spy 和右侧可滚动详情内容。',
    matchedPatterns: ['AccountDetailModalFrame'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['section-nav', 'scroll-spy', 'long-content'],
    mockDataSources: ['storybook account detail section nav mock'],
  },
  {
    id: 'accounts-account-detail-models-section',
    componentName: 'AccountDetailModelsSection',
    sourcePath: 'frontend/src/features/accounts/components/AccountDetailModelsSection.tsx',
    ownerFeature: 'accounts',
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '账号详情模型映射 section 已从统一详情 modal 中拆出，覆盖 auth-file 只读模型、api-key 可编辑映射和模型拉取状态。',
    matchedPatterns: ['AccountDetailPrimitives', 'Combobox'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['readonly-models', 'editable-mapping', 'fetch-status', 'empty-state'],
    mockDataSources: ['storybook model mapping mock', 'previewData auth-file model mock'],
  },
  {
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '统一账号详情页的 header、credentials、verify、quota、billing 和 footer 已拆成无 Wails 的 section 组件；当前由 AccountDetailLayout 的 section-nav 承载详情页结构，并通过 Account Modals story 收编。',
    matchedPatterns: ['AccountDetailModalFrame', 'Combobox', 'ToggleSwitch'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['ready', 'standard-module-header', 'stacked-quota-billing', 'missing-fields', 'saving-footer', 'live-billing'],
  ...
  },
  {
    ...
    storybookTitle: accountGroupSectionStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['full-grid', 'list', 'empty'],
  ...
  },
  {
    ...
    catalogGroupId: 'feature-components',
    requiredStates: ['full-list', 'selection-list', 'filtered-empty'],
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '归因卡已通过 Account Cards story 收编，覆盖健康、失败、带额度条和列表密度。',
    matchedPatterns: ['DebugPanel EntryCard'],
    storyPath: accountCardStoryPath,
    storybookTitle: accountCardStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['healthy', 'limited', 'failed', 'quota', 'long-content'],
  ...
  },
  {
    ...
    matchedPatterns: ['ModalFrame', 'quiet-input', 'quiet-action-button'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
  ...
  {
    id: 'accounts-account-import-queue-list',
    componentName: 'AccountImportQueueList',
    sourcePath: 'frontend/src/features/accounts/components/AccountImportQueueList.tsx',
    ownerFeature: 'accounts',
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '导入候选队列列表随 AccountImportModal 通过 Account Modals story 收编，覆盖空队列后的混合候选和滚动预览状态。',
    matchedPatterns: ['quiet-card', 'virtualized-list', 'destructive-icon-button'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['queued', 'mixed-source', 'scroll-preview'],
    mockDataSources: ['storybook account import file/paste payload mock'],
  },
  {
    id: 'accounts-quota-calibration-panel',
    componentName: 'QuotaCalibrationPanel',
    sourcePath: 'frontend/src/features/accounts/components/QuotaCalibrationPanel.tsx',
    ownerFeature: 'accounts',
    status: 'deferred',
    tier: 'feature-component',
    decisionReason: '额度校准面板依赖账号详情上下文、quota windows 和保存回调，当前随 AccountDetailSections 运行态复用，不单独进入设计系统 story。',
    matchedPatterns: ['AccountDetailSection', 'Quota editor'],
    suggestedDesignComponent: 'QuotaCalibrationPanel',
    revisitTrigger: '为账号详情 story 补充 quota calibration active/history/form 状态矩阵后复查。',
  },
  {
    id: 'accounts-quota-threshold-rule-panel',
    componentName: 'QuotaThresholdRulePanel',
    sourcePath: 'frontend/src/features/accounts/components/QuotaThresholdRulePanel.tsx',
    ownerFeature: 'accounts',
    status: 'deferred',
    tier: 'feature-component',
    decisionReason: '额度阈值规则面板依赖账号详情上下文、quota windows 和规则保存回调，当前随 AccountDetailSections 运行态复用，不单独进入设计系统 story。',
    matchedPatterns: ['AccountDetailSection', 'Quota rule editor'],
    suggestedDesignComponent: 'QuotaThresholdRulePanel',
    revisitTrigger: '为账号详情 story 补充 quota threshold draft/list/empty 状态矩阵后复查。',
  },
  {
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '统一新增弹窗和 provider 卡片复用的品牌徽记 helper 已由 Account Modals story 的 Unified Compose preset list/form step 覆盖。',
    matchedPatterns: ['InlineBrandMark'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['preset-logo', 'selected-logo', 'initials-fallback'],
    mockDataSources: ['storybook unified compose vendor preset mock'],
  },
  {
  ...
  {
    id: 'channel-routing-project-candidate-pool-rules-modal',
    componentName: 'ProjectCandidatePoolRulesModal',
    sourcePath: 'frontend/src/features/channel-routing/components/ProjectCandidatePoolRulesModal.tsx',
    ownerFeature: 'channel-routing',
    status: 'deferred',
    tier: 'feature-component',
    decisionReason: '项目候选池规则弹窗先随 Codex/Claude account-list 页面进入业务验收；当前已复用 ModalFrame 全视口详情弹窗，并由 channel routing 单元测试覆盖入口和布局约束。',
    matchedPatterns: ['ModalFrame', 'ChannelRoutingWorkbench'],
    suggestedDesignComponent: 'ProjectCandidatePoolRulesDialog',
    revisitTrigger: '项目候选池规则交互稳定后补独立 story，覆盖无历史项目、创建、更新、禁用和删除状态。',
  },
  {
    id: 'channel-routing-project-candidate-pool-rules-panel',
    componentName: 'ProjectCandidatePoolRulesPanel',
    sourcePath: 'frontend/src/features/channel-routing/components/ProjectCandidatePoolRulesPanel.tsx',
    ownerFeature: 'channel-routing',
    status: 'deferred',
    tier: 'feature-component',
    decisionReason: '项目候选池规则编辑面板是跨 Codex/Claude 的路由配置业务表单，先随项目配置弹窗验收；当前由 channel routing 测试覆盖平铺布局、历史项目选择和账号候选池文案。',
    matchedPatterns: ['SegmentedControl', 'ToggleSwitch', 'DebugPanel list'],
    suggestedDesignComponent: 'ProjectCandidatePoolRulesEditor',
    revisitTrigger: '项目候选池规则数据模型稳定后补 story matrix，覆盖空项目、推荐项目、账号多选、保存中、校验错误和已有规则列表。',
  },
  {
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: 'Codex 账号详情已收敛到统一账号详情 Modal，保留 Codex adapter 和桌面新版草稿 story 作为设计系统入口。',
    matchedPatterns: ['UnifiedAccountDetailModal', 'AccountDetailSection', 'Combobox'],
