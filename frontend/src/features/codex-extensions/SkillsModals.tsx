...
const codexSkillModalDangerButtonClass =
  'inline-flex min-h-9 w-fit items-center gap-2 rounded border border-[var(--gt-status-danger)] bg-[var(--gt-surface-raised)] px-3 py-1.5 text-[length:var(--gt-font-size-sm)] font-medium text-[var(--gt-status-danger)] transition hover:bg-[color-mix(in_srgb,var(--gt-status-danger)_8%,transparent)] disabled:cursor-not-allowed disabled:opacity-50';
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-[var(--overlay-scrim-85)] p-4" onClick={() => setRemoveAlertOpen(false)}>
          ...
          >
            <header className="flex items-start gap-3 border-b border-[var(--gt-status-danger)] bg-[var(--gt-surface-muted)] p-4">
              ...
              <div className="min-w-0">
                <div id="codex-skill-remove-alert-title" className="font-mono text-base font-semibold italic text-[var(--gt-ink-primary)]">
            ...
            <div className="space-y-3 p-4">
              <p className="text-sm font-bold leading-relaxed text-[var(--gt-ink-primary)]">
