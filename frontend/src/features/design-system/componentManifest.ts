...
export const designSystemComponentManifest = [
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: 'Codex 运行会话 feed 表格已随 CodexLiveSessionsWorkbench story 收编，覆盖 active、degraded、empty、selected row 和 high-volume rows。',
  ...
  {
    id: 'codex-live-session-summary',
    componentName: 'SummaryStrip',
    sourcePath: 'frontend/src/features/codex-live-sessions/components/CodexLiveSessionSummary.tsx',
    ownerFeature: 'codex-live-sessions',
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: 'Codex 运行会话 summary strip 与 source badge 已随 CodexLiveSessionsWorkbench story 收编，覆盖 live、cache/unavailable、empty 和 high-volume 汇总。',
    matchedPatterns: ['DebugPanel summary cards'],
    storyPath: codexLiveSessionsStoryPath,
    storybookTitle: codexLiveSessionsStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['live', 'cache', 'unavailable', 'empty', 'high-volume'],
    mockDataSources: ['codexLiveSessionsPreviewSnapshot', 'codexLiveSessionsHighVolumeSnapshot'],
  },
  {
