...
const cases = [
  {
    ...
    requiredSelectors: [
      ...
      '.settings-antd-spike .ant-card',
      '.settings-antd-spike .ant-segmented',
      '.settings-antd-spike .ant-switch',
      '[data-theme-preset-option="classic"]',
      '[data-theme-preset-option="parchment-trust-console"]',
    ],
    requiredTexts: ['界面风格', 'CLASSIC CONSOLE', 'PARCHMENT TRUST CONSOLE'],
  ...
  },
  {
    ...
    requiredTexts: ['主题风格', 'PARCHMENT TRUST CONSOLE', 'STORYBOOK'],
