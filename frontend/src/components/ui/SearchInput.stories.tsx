...
function SearchInputOverview() {
  ...
  return (
    <div className="grid w-full max-w-5xl gap-4 bg-[var(--gt-surface-muted)] p-6">
      <div>
        <h2 className="text-2xl font-semibold tracking-normal">SearchInput</h2>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="grid gap-3 border-[1px] border-[color:color-mix(in_srgb,var(--gt-border-strong)_55%,transparent)] bg-[var(--gt-surface-canvas)] p-4">
          <h3 className="text-sm font-semibold tracking-normal">{zh ? '带值' : 'Filled'}</h3>
          <SearchInputSample initialValue="filesystem" />
        </section>
        <section className="grid gap-3 border-[1px] border-[color:color-mix(in_srgb,var(--gt-border-strong)_55%,transparent)] bg-[var(--gt-surface-canvas)] p-4">
          <h3 className="text-sm font-semibold tracking-normal">{zh ? '窄容器' : 'Narrow'}</h3>
