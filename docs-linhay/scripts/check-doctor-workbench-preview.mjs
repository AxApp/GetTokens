...
const checks = {
  ...
  omniRouteActionSurfaceSource: hasAny(featureSource, [
    /data-omniroute-workbench-action-surface="true"/,
    /data-omniroute-workbench-action=/,
    /data-omniroute-workbench-action-status=/,
    /safeActionSurface\.actions\.map/,
  ]),
  omniRouteModelSource: hasAny(modelSource, [
    /deriveOmniRouteWorkbenchProductizationView/,
    /OmniRouteWorkbenchSignalActionView/,
    /buildAccountDetailHashFromEvidence/,
  ...
  routeActionSurfaceWired: hasAny(featureSource, [
    /RunRouteResilienceAction/,
    /RouteResilienceActionInput\.createFrom/,
    /recheck_routeability/,
    /doctor-workbench:route-recheck/,
  ]),
  noExtensionRealApplyInDoctor: !/PrepareGetTokensExtensionCodexConfigApply|ApplyGetTokensExtensionCodexConfigTransaction/.test(featureSource),
...
if (missing.length > 0) {
  console.error(JSON.stringify({
    ...
    hints: {
      ...
      omniRouteActionSurfaceSource: missingCheck(featureSource, [
        'data-omniroute-workbench-action-surface="true"',
        'data-omniroute-workbench-action=',
        'data-omniroute-workbench-action-status=',
        'safeActionSurface.actions.map',
      ]),
      routeActionSurfaceWired: missingCheck(featureSource, [
        'RunRouteResilienceAction',
        'RouteResilienceActionInput.createFrom',
        'recheck_routeability',
        'doctor-workbench:route-recheck',
