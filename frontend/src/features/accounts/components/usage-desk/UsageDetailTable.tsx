...
const usageDetailTableHeaderCellClass =
  'border-b border-[var(--gt-border-subtle)] px-3 py-3 text-left text-[length:var(--gt-font-size-sm)] font-normal tracking-normal text-[var(--gt-ink-primary)]';
...
const usageDetailTableCellClass = 'px-3 py-3 text-[length:var(--gt-font-size-md-compact)] font-normal leading-6';
