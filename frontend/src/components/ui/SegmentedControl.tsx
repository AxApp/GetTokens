...
export default function SegmentedControl<T extends string>({
  ...
  return (
    <div
      ...
      className={`relative ${fitContent ? 'inline-flex w-auto max-w-none' : 'flex w-full max-w-sm'} overflow-hidden border-[1px] border-[color:color-mix(in_srgb,var(--border-color)_55%,transparent)] bg-[var(--bg-main)] ${
        disabled ? 'opacity-60' : ''
      }`}
    >
