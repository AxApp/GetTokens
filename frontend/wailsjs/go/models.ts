...
export namespace main {
	...
	export class SetAccountsDisabledBatchError {
	    accountID: string;
	    error: string;

	    static createFrom(source: any = {}) {
	        return new SetAccountsDisabledBatchError(source);
	    }
	...
	export class SetAccountsDisabledBatchInput {
	    accountIDs: string[];
	    disabled: boolean;

	    static createFrom(source: any = {}) {
	        return new SetAccountsDisabledBatchInput(source);
	    }
	...
	export class SetAccountsDisabledBatchResult {
	    updatedAccountIDs: string[];
	    errors: SetAccountsDisabledBatchError[];
	    succeeded: number;
	    failed: number;

	    static createFrom(source: any = {}) {
	        return new SetAccountsDisabledBatchResult(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.updatedAccountIDs = source["updatedAccountIDs"];
	        this.errors = this.convertValues(source["errors"], SetAccountsDisabledBatchError);
	        this.succeeded = source["succeeded"];
	        this.failed = source["failed"];
	    }
