...
export interface VendorPreset {
  ...
  quotaSetupGuide?: string[];
  billingSetupGuide?: string[];
  notes?: string;
  consoleUrl?: string;
  variantLabel?: string;
...
const XIAOMI_MIMO_COOKIE_GUIDE = [
  "登录 platform.xiaomimimo.com，并保持当前浏览器会话有效。",
...
export const vendorPresets: VendorPreset[] = [
  ...
  // ==================== Chinese Vendors (Anthropic-compatible) ====================
  {
    ...
    modelSuggestions: ["deepseek-v4-pro[1m]", "deepseek-v4-flash", "deepseek-v4-pro"],
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["glm-5.2[1m]", "glm-5.2", "glm-4.5-air", "glm-5", "glm-4.7"],
    category: "cn_official",
    icon: "zhipu",
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["kimi-k2.7-code", "kimi-k2.6", "kimi-k2.5"],
    category: "cn_official",
    icon: "kimi",
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["step-3.7-flash", "step-3.6", "step-3.5-flash-2603"],
    category: "cn_official",
    icon: "stepfun",
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["MiniMax-M3", "MiniMax-M2.7"],
    category: "cn_official",
    icon: "minimax",
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["ark-code-latest", "doubao-seed-2-0-code-preview-latest"],
    category: "cn_official",
    icon: "doubao",
  ...
  },
  {
    ...
    apiKeyPlaceholder: "sk-...",
    modelSuggestions: ["gpt-4.1", "gpt-5-codex", "claude-sonnet-4-6"],
    category: "aggregator",
    websiteUrl: "https://github.com/Wei-Shaw/sub2api",
    notes: "Self-hosted relay preset; edit each endpoint to match your deployment.",
  },
  {
    id: "new-api",
    name: "New API",
    ...
    modelSuggestions: ["gpt-4.1", "gpt-5-codex", "claude-sonnet-4-6"],
    category: "aggregator",
    websiteUrl: "https://github.com/QuantumNous/new-api",
    notes: "Self-hosted relay preset; edit each endpoint to match your deployment.",
  },
