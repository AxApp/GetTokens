...
export const designSystemComponentManifest = [
  {
    ...
    decisionReason: '完整账号卡已通过 Account Cards story 收编，覆盖常规、带额度条的缩略模式、选择、待删除和列表阻断态，auth file 下载依赖已由 runtime wrapper 通过 downloadAuthFile prop 注入。',
    ...
    requiredStates: ['ready', 'compact-quota', 'selection-selected', 'pending-delete', 'list-blocked'],
