...
export const designSystemComponentManifest = [
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '统一账号详情页的 header、credentials、verify、quota、billing 和 footer 已拆成无 Wails 的 section 组件，并通过 Account Modals story 收编。',
    matchedPatterns: ['AccountDetailModalFrame', 'Combobox', 'ToggleSwitch'],
    storyPath: accountModalStoryPath,
    storybookTitle: accountModalStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['ready', 'missing-fields', 'saving-footer', 'live-billing'],
  ...
  },
  {
    ...
    status: 'admitted',
    tier: 'feature-component',
    decisionReason: '账号指标段已通过 Account Cards story 收编，覆盖 quota、quota 内部刷新骨架、billing、usage、rate-limit 和 evidence。',
    matchedPatterns: ['DebugPanel state matrix'],
    storyPath: accountCardStoryPath,
    storybookTitle: accountCardStorybookTitle,
    catalogGroupId: 'feature-components',
    requiredStates: ['quota', 'quota-refreshing', 'usage', 'billing', 'rate-limit', 'evidence'],
